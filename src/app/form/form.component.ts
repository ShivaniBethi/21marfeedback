...
export class FormComponent implements OnInit {
  ...
  disappearTraining: Training;
  hide: boolean = false;
  
  onSelectionChange(disappearTraining: Training) {
    this.trainingID = disappearTraining.TrainingID;
    this.hide = true;
    var input = $('<p ><b>Program Name: </b>' + disappearTraining.TrainingName + '</p> <p ><b>Trainer: </b>' + disappearTraining.Trainer + '</p> <p ><b>Date: </b>' + disappearTraining.Date + '</p><p ><b>Venue: </b>' + disappearTraining.Venue + '</p><br/> ')
    $('.text-info1').text('').append(input);
  }
  
  onSelect(parameter: number,printQuestion:string) {
