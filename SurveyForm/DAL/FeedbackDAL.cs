...
namespace DAL
{
    public class FeedbackDAL
    {
        ...
        public string UserLogIn(Admin admin)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("SELECT [UserName],[Password] FROM [Admin] WHERE [UserName]=@name AND [Password]= @password", connection);
                ...
                var userDataReader = cmd.ExecuteReader();
